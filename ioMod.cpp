...
void IoMod::writeText(const std::string& msg, int x, int y,SDL_Color color) const {
  SDL_Surface* surface = 
    TTF_RenderText_Blended_Wrapped(font, msg.c_str(), color,270);
...
void IoMod::writeText1(const std::string& msg, int x, int y,SDL_Color color) const {
  SDL_Surface* surface = 
    TTF_RenderText_Blended_Wrapped(font1, msg.c_str(), color,270);
